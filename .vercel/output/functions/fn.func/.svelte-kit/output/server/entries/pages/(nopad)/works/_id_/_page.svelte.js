import { c as create_ssr_component, i as compute_rest_props, f as each, v as validate_component, m as missing_component, e as escape$1, j as getContext, b as add_attribute, k as createEventDispatcher, a as setContext, d as null_to_empty, g as subscribe } from "../../../../../chunks/ssr.js";
import { C as Container } from "../../../../../chunks/container.js";
import FiX from "svelte-icons-pack/fi/FiX.js";
import { o as onNavigate, I as Icon } from "../../../../../chunks/Icon.js";
import "svelte-icons-pack/bs/BsPlusSquare.js";
import "svelte-icons-pack/bs/BsDashSquare.js";
import "svelte-icons-pack/bs/BsDice1.js";
import "svelte-icons-pack/bs/BsXLg.js";
...
const Link = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.title === void 0 && $$bindings.title && title !== void 0)
    $$bindings.title(title);
  return `<a rel="noopener noreferrer" target="_blank"${add_attribute("href", href, 0)}${add_attribute("title", title, 0)}>${slots.default ? slots.default({}) : ``}</a>`;
});
const index_svelte_svelte_type_style_lang$4 = "";
const css$2 = {
  code: '@charset "UTF-8";@keyframes svelte-1oux4cw-fadeIn{0%{opacity:0}100%{opacity:1}}.text.svelte-1oux4cw.svelte-1oux4cw{--pad-height:0px;animation-name:svelte-1oux4cw-fadeIn;animation-delay:100ms;animation-duration:500ms;animation-fill-mode:both;position:relative}.text.svelte-1oux4cw .pad.svelte-1oux4cw,.text.svelte-1oux4cw .visible.svelte-1oux4cw{max-width:600px;margin:0 auto;padding:1rem 2rem;padding-top:55px;padding-bottom:89px;line-height:1.63rem}.text.svelte-1oux4cw .pad.svelte-1oux4cw ul,.text.svelte-1oux4cw .pad.svelte-1oux4cw ol,.text.svelte-1oux4cw .visible.svelte-1oux4cw ul,.text.svelte-1oux4cw .visible.svelte-1oux4cw ol{margin-left:1.2rem}.text.svelte-1oux4cw .pad.svelte-1oux4cw p,.text.svelte-1oux4cw .visible.svelte-1oux4cw p{margin-bottom:1rem}.text.svelte-1oux4cw .pad.svelte-1oux4cw blockquote,.text.svelte-1oux4cw .visible.svelte-1oux4cw blockquote{background-color:rgba(64, 64, 64, 0.34);padding:1.6rem 2rem;position:relative;overflow:hidden;z-index:0;margin-bottom:1rem;border-radius:8px}.text.svelte-1oux4cw .pad.svelte-1oux4cw blockquote:before,.text.svelte-1oux4cw .visible.svelte-1oux4cw blockquote:before{font-family:Times New Roman, Times, serif;content:"”";position:absolute;top:34px;left:0;font-size:144px;color:#333;z-index:-1}.text.svelte-1oux4cw .pad.svelte-1oux4cw blockquote p,.text.svelte-1oux4cw .visible.svelte-1oux4cw blockquote p{margin:0;padding:0}.text.svelte-1oux4cw .pad.svelte-1oux4cw{opacity:0;height:var(--pad-height)}.text.svelte-1oux4cw .visible.svelte-1oux4cw{position:absolute;top:0;left:0}@media screen and (min-width: 420px){.text.svelte-1oux4cw .pad.svelte-1oux4cw,.text.svelte-1oux4cw .visible.svelte-1oux4cw{padding-left:4rem;padding-right:4rem}}@media screen and (min-width: 1024px){.text.svelte-1oux4cw .visible.fixed.svelte-1oux4cw{width:432px;position:fixed;bottom:0px;top:auto;height:auto;left:calc(50% + min(var(--max-width), 100%) / 2 - 432px)}}',
  map: null
};
const Text = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let padHeight = 0;
  let text;
  const { content, url, year } = work;
  const urlText = url.replace(/https?\:\/\/(www\.)?/, "");
  if ($$props.work === void 0 && $$bindings.work && work !== void 0)
    $$bindings.work(work);
  $$result.css.add(css$2);
  return `<div class="${escape$1(null_to_empty(`text`), true) + " svelte-1oux4cw"}"${add_attribute("style", `--pad-height: ${padHeight}px`, 0)}>${validate_component(Container, "Container").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="pad svelte-1oux4cw"></div> <div class="${[
        escape$1(null_to_empty(`visible`), true) + " svelte-1oux4cw",
        ""
      ].join(" ").trim()}"${add_attribute("this", text, 0)}><p><a${add_attribute("href", url, 0)} rel="noopener noreferrer" target="_blank">${escape$1(urlText)}</a></p> <p>Year: ${escape$1(year)}</p> <br> ${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render(
        $$result,
        {
          source: content,
          renderers: { link: Link }
        ...
        {},
        {}
      )} </div> <div${add_attribute("this", observed, 0)}></div>`;
    }
  })} </div>`;
});
...
const css$1 = {
  code: "@keyframes svelte-12jt2y1-fadeIn{0%{opacity:0}100%{opacity:1}}.slider.svelte-12jt2y1.svelte-12jt2y1{position:relative;padding-top:56.25%;overflow-x:scroll;overflow-y:hidden;scroll-behavior:smooth;scroll-snap-type:x mandatory;user-select:none;overscroll-behavior:none;-webkit-user-select:none;-webkit-touch-callout:none}.slider.svelte-12jt2y1 .slide.svelte-12jt2y1{position:absolute;top:0;left:0;width:100%;height:100%}.slider.svelte-12jt2y1 .slide .slide-content.svelte-12jt2y1{height:100%;display:flex}.slider.svelte-12jt2y1 .slide .slide-content a.svelte-12jt2y1{scroll-snap-align:center;display:block;width:100%;height:100%}.slider.svelte-12jt2y1 .slide .slide-content a.svelte-12jt2y1::after{content:unset;display:none}.slider.svelte-12jt2y1 .slide .slide-content a.svelte-12jt2y1::before{content:unset;display:none}.slider.svelte-12jt2y1 .slide .slide-content a.svelte-12jt2y1 img{width:100%;height:100%;object-fit:cover;object-position:center top;padding:0;display:block;animation:svelte-12jt2y1-fadeIn;animation-duration:300ms;animation-fill-mode:both}@media screen and (min-width: 1024px){.slider.svelte-12jt2y1.svelte-12jt2y1{padding-top:initial}.slider.svelte-12jt2y1 .slide.svelte-12jt2y1{position:static}.slider.svelte-12jt2y1 .slide .slide-content.svelte-12jt2y1{width:100% !important;height:auto;display:block}.slider.svelte-12jt2y1 .slide .slide-content a.svelte-12jt2y1{margin-bottom:0.5rem}}",
  map: null
};
const Slider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="slider svelte-12jt2y1"${add_attribute("this", slider, 0)}><div class="slide svelte-12jt2y1"><div class="slide-content svelte-12jt2y1"${add_attribute("style", `width: ${images.length * 100}%`, 0)}${add_attribute("this", sliderContent, 0)}>${each(images, (image, i) => {
    return `<a${add_attribute("href", image.original.url, 0)} target="_blank" class="svelte-12jt2y1">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        draggable: false,
...
const css = {
  code: ".details.svelte-1ktrlxl .title.svelte-1ktrlxl{--padding-y:0.5rem;padding:var(--padding-y) var(--pad-x);padding-top:calc(var(--padding-y) + var(--pad-top-page));position:sticky;top:0;background:var(--subtitle-header-bg);backdrop-filter:blur(5px);z-index:1}.details.svelte-1ktrlxl .title.svelte-1ktrlxl>.container{display:flex;align-items:center;justify-content:space-between}.details.svelte-1ktrlxl .title h2.svelte-1ktrlxl{font-weight:300;font-size:1.2rem}.details.svelte-1ktrlxl .title a.svelte-1ktrlxl{font-size:1.5rem;color:red}@media screen and (min-width: 1024px){.details.svelte-1ktrlxl .content.svelte-1ktrlxl{max-width:var(--max-width);margin:0 auto;display:grid;grid-template-columns:1fr 432px}}",
  map: null
};
const Work_details = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { work } = $$props;
  const { id, title, images, gradientColor } = work || {};
  const href = `/#works/${id}`;
  let sliderImages;
  if ($$props.work === void 0 && $$bindings.work && work !== void 0)
    $$bindings.work(work);
  ...
  return `<div class="${escape$1(null_to_empty("details"), true) + " svelte-1ktrlxl"}"><div class="title svelte-1ktrlxl">${validate_component(Container, "Container").$$render($$result, {}, {}, {
    default: () => {
      return `<h2 class="svelte-1ktrlxl">${escape$1(title)}</h2> <a${add_attribute("href", href, 0)} class="svelte-1ktrlxl">${validate_component(Icon, "Icon").$$render($$result, { src: FiX }, {}, {})}</a>`;
    }
  })}</div> <div class="content svelte-1ktrlxl">${validate_component(Slider, "Slider").$$render($$result, { images: sliderImages }, {}, {})} ${validate_component(Text, "Text").$$render($$result, { work }, {}, {})}</div> </div>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${validate_component(Work_details, "WorkDetails").$$render($$result, { work: data }, {}, {})}`;
});
export {
  Page as default
};
